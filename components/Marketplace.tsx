        ...
        <div className="p-4 md:p-8 space-y-8">
            <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Discover exclusive digital and physical goods.</p>
                </div>
            ...
            <Card>
                <div className="text-center py-20">
                    ...
                    <p className="mt-2 text-gray-500 dark:text-gray-400">Our marketplace is under construction. Get ready to explore a universe of unique items.</p>
                </div>
            </Card>

            <div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Sneak Peek</h2>
